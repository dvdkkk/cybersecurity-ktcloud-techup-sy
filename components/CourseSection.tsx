...
const CURRICULUM_DATA = [
  ...
  },
  {
    ...
    desc: "고급 보안 솔루션을 구현하고 해커톤을 통해 창의적 해결능력을 기릅니다.",
                ...
                {CURRICULUM_DATA.map((item) => (
                  <button
                    ...
                    className={`
                      ...
                      ${isMobile 
                        ? 'flex-1 justify-center text-[10px] sm:text-[11px] py-2.5 px-0 rounded-lg shadow-sm font-bold' // 모바일: 꽉 찬 너비, 작은 폰트, 중앙 정렬
